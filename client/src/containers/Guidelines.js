...
var Guidelines = () => (
  <div className="container">
    ...
    <span>
      ...
      <ul>
        <li>
          Click on the button &apos;Bot with rack distance threshold&apos;
        </li>
      ...
      Note: Bot with rack distance threshold decides which barcodes&apos;
      neighbour structure will allow butler going to the next barcode with rack
      or not. If the distance between two barcodes is less than 750 (given
      above), map will allow movement with rack to this barcode. However, if the
      distance is less than 750, map will show neighbour structure as [1,1,0]
